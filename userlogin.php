    ...
    <div class="navigation-bar">
      ...
      <div id="navigation-container">
        ...
        <ul>
          ...
          <li><a href="services.html">Circulations</a></li>
...
<br>
   <h3 style="color: white; font-size: 30px; text-align: center;">Login for Students </h3>
        <div style="border-radius: 5px;display: block;margin-left: auto;margin-top:30px;margin-right: auto;width: 30%;padding: 20px;";align="cenetr">
        ...
        <br><br>
        <a href="loginadmin.html" style="color: white; font-size: 20px;"><center>Login For Admin</center></a>
