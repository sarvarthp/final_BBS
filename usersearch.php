...
if ($upd->num_rows > 0) {
echo '<center><span style="color:white;text-align:center;"><h2>This book is available<h2></span></center>';
echo"<style>
      th{
        font-size: 30px;
        color:white;
...
{
echo '<center><span style="color:white;text-align:center;"><h2>This book is not available</h2></span></center>';
